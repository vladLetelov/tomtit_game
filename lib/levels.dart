  ...
  0: LevelModel(
    ...
    history: [
      ...
      HistoryModel(
          ...
          description:
              'Для просмотра истории необходимо перелистывать карточки, с полезной информацией, для это на телефоне достаточно пальцем пролистать слева-направо/справа-налево, на ноутбуке можно использовать тачпад, где перелистывание в обе стороны происходит двумя пальцами, либо на клвавиатуре можно использовать стрелочки впрво/влево. Более подробно познакомится с управлением можно познакомится перейдя на главный экран и нажав на кнопку ? в правом верхнем углу.'),
    ],
